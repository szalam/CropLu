...
df = read.csv('fallow_and_cropland_with_pasture.csv')
head(df)
colnames(df) = c('Region' ,'Year'   ,'c.area' ,'type')
...
ggsave(p,filename=paste0(wd$figure3,"tot_crop_pasture_area",".png",sep=""),
